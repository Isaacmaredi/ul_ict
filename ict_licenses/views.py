...
from .forms import LicenseCreateForm, LicenseRenewForm
...
class LicenseRenewView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    form_class = LicenseRenewForm
    model = License
    context_object_name = 'license'
